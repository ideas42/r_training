...
Note that **all of this is new**. If you have any feedback or have thoughts on other specific trainings we could cover, you know where I live (virtually).
...
- In that sense it's like Stata. Who's been to the Stata training?
...
- The world is your oyster (see this prez)
...
- We don't have a GDP variable! Let's create it by multiplying GDP per capita times the population, and save it as a new dataframe.
